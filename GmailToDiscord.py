...
DISCORD_WEBHOOK_URL = 'https://discord.com/api/webhooks/your-webook-url'
...
keywords = ['curseforge', 'modrinth', 'spigot', 'bukkit', 'paper']
...
for msgnum in msgnums[0].split()[::-1]:  # reverse order to get oldest first
    ...
    if not any(keyword in subject.lower() or keyword in body.lower() for keyword in keywords):
